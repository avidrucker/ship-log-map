      ...
      >
        ...
        <div style={{ marginBottom: "10px", display: "flex", gap: "10px", flexWrap: "wrap" }}>
          ...
          <button
            ...
            onClick={() => window.location.href = `${window.location.origin}${import.meta.env.BASE_URL}?map=https%3A%2F%2Favidrucker.github.io%2Fimg-test-1%2FGaia%2520Yoga%2Fgaia_yoga.json&canedit=true`}
          >
            Go to Gaia Yoga Map
          </button>
          <button
            ...
            onClick={() => window.location.href = `${window.location.origin}${import.meta.env.BASE_URL}?map=https%3A%2F%2Favidrucker.github.io%2Fimg-test-1%2FOuter%2520Wilds%2Fouter_wilds.json&canedit=true`}
          >
