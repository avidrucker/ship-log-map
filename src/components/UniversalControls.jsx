// src/components/UniversalControls.jsx

/**
 * UniversalControls — App-wide controls not specific to graph editing
 *
 * Responsibilities
 * - Top bar/side panel with app mode, map chooser, share/import/export entry
 *   points, feature toggles (e.g., animations flag placeholder).
 *
 * Props
 * - mode, onModeChange, onOpenShareModal, onOpenImport, onOpenDebug, etc.
 */
